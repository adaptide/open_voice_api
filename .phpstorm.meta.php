...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/open-voice/open-voice-api/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./var/www/open-voice/open-voice-api/public/storage','l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api',
...
'livewire.navigate.progress_bar_color','livewire.inject_morph_markers','livewire.pagination_theme','media-library.disk_name','media-library.max_file_size',
...
'filament.imports.failed-rows.download','filament.admin.auth.login','filament.admin.auth.logout','filament.admin.pages.dashboard','filament.organization.auth.login',
'filament.organization.auth.logout','filament.organization.pages.dashboard','filament.organization.tenant','sanctum.csrf-cookie','livewire.update','livewire.upload-file','livewire.preview-file','storage.local',);
        registerArgumentsSet('views', 
'components.filament-audio-preview','filament-panels::components.avatar.tenant','filament-panels::components.avatar.user','filament-panels::components.form.actions','filament-panels::components.form.index',
...
'filament-panels::resources.pages.view-record','filament-panels::resources.relation-manager','filament-panels::widgets.account-widget','filament-panels::widgets.filament-info-widget','l5-swagger::index',
'vendor.filament-panels.components.avatar.tenant','vendor.filament-panels.components.avatar.user','vendor.filament-panels.components.form.actions','vendor.filament-panels.components.form.index','vendor.filament-panels.components.global-search.actions',
'vendor.filament-panels.components.global-search.field','vendor.filament-panels.components.global-search.index','vendor.filament-panels.components.global-search.no-results-message','vendor.filament-panels.components.global-search.result','vendor.filament-panels.components.global-search.result-group',
'vendor.filament-panels.components.global-search.results-container','vendor.filament-panels.components.header.index','vendor.filament-panels.components.header.simple','vendor.filament-panels.components.layout.base','vendor.filament-panels.components.layout.index',
'vendor.filament-panels.components.layout.simple','vendor.filament-panels.components.logo','vendor.filament-panels.components.page.index','vendor.filament-panels.components.page.simple','vendor.filament-panels.components.page.sub-navigation.select',
'vendor.filament-panels.components.page.sub-navigation.sidebar','vendor.filament-panels.components.page.sub-navigation.tabs','vendor.filament-panels.components.page.unsaved-data-changes-alert','vendor.filament-panels.components.resources.relation-managers','vendor.filament-panels.components.resources.tabs',
'vendor.filament-panels.components.sidebar.group','vendor.filament-panels.components.sidebar.index','vendor.filament-panels.components.sidebar.item','vendor.filament-panels.components.tenant-menu','vendor.filament-panels.components.theme-switcher.button',
'vendor.filament-panels.components.theme-switcher.index','vendor.filament-panels.components.topbar.database-notifications-trigger','vendor.filament-panels.components.topbar.index','vendor.filament-panels.components.topbar.item','vendor.filament-panels.components.unsaved-action-changes-alert',
'vendor.filament-panels.components.user-menu','vendor.filament-panels.pages.auth.edit-profile','vendor.filament-panels.pages.auth.email-verification.email-verification-prompt','vendor.filament-panels.pages.auth.login','vendor.filament-panels.pages.auth.password-reset.request-password-reset',
'vendor.filament-panels.pages.auth.password-reset.reset-password','vendor.filament-panels.pages.auth.register','vendor.filament-panels.pages.dashboard','vendor.filament-panels.pages.tenancy.edit-tenant-profile','vendor.filament-panels.pages.tenancy.register-tenant',
'vendor.filament-panels.resources.pages.create-record','vendor.filament-panels.resources.pages.edit-record','vendor.filament-panels.resources.pages.list-records','vendor.filament-panels.resources.pages.manage-related-records','vendor.filament-panels.resources.pages.view-record',
'vendor.filament-panels.resources.relation-manager','vendor.filament-panels.widgets.account-widget','vendor.filament-panels.widgets.filament-info-widget','vendor.l5-swagger.index','welcome',
...
'filament::components.section.heading','filament::components.section.index','filament::components.tabs.index','filament::components.tabs.item','l5-swagger::index',
...
'filament-actions::import.label','filament-actions::import.modal.heading','filament-actions::import.modal.form.file.label','filament-actions::import.modal.form.file.placeholder','filament-actions::import.modal.form.columns.label',
...
'filament-actions::import.failure_csv.file_name','filament-actions::import.failure_csv.error_header','filament-actions::import.failure_csv.system_error','filament-actions::modal.confirmation','filament-actions::modal.actions.cancel.label',
...
'filament-forms::components.builder.actions.add_between.label','filament-forms::components.builder.actions.delete.label','filament-forms::components.builder.actions.reorder.label','filament-forms::components.builder.actions.move_down.label','filament-forms::components.builder.actions.move_up.label',
...
'filament-forms::components.rich_editor.toolbar_buttons.underline','filament-forms::components.rich_editor.toolbar_buttons.undo','filament-forms::components.select.actions.create_option.modal.heading','filament-forms::components.select.actions.create_option.modal.actions.create.label','filament-forms::components.select.actions.create_option.modal.actions.create_another.label',
...
'filament-tables::table.column_toggle.heading','filament-tables::table.columns.text.actions.collapse_list','filament-tables::table.columns.text.actions.expand_list','filament-tables::table.columns.text.more_list_items','filament-tables::table.fields.bulk_select_page.label',
...
'CACHE_STORE','CACHE_PREFIX','CACHE_DRIVER','MEMCACHED_HOST','REDIS_CLIENT',
