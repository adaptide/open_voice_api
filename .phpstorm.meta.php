...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/clients/open-voice/open-voice-api/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./var/www/clients/open-voice/open-voice-api/public/storage','l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api',
...
'filament.imports.failed-rows.download','filament.admin.auth.login','filament.admin.auth.logout','filament.admin.pages.dashboard','filament.admin.resources.organizations.index',
'filament.admin.resources.organizations.create','filament.admin.resources.organizations.edit','filament.admin.resources.projects.index','filament.admin.resources.projects.create','filament.admin.resources.projects.edit',
'filament.admin.resources.recordings.index','filament.admin.resources.recordings.create','filament.admin.resources.recordings.edit','filament.admin.resources.texts.index','filament.admin.resources.texts.create',
'filament.admin.resources.texts.edit','filament.admin.resources.users.index','filament.admin.resources.users.create','filament.admin.resources.users.edit','filament.organization.auth.login',
'filament.organization.auth.logout','filament.organization.tenant.registration','filament.organization.pages.dashboard','filament.organization.tenant.profile','filament.organization.resources.projects.index',
'filament.organization.resources.projects.create','filament.organization.resources.projects.edit','filament.organization.resources.texts.index','filament.organization.resources.texts.create','filament.organization.resources.texts.edit',
'filament.organization.resources.recordings.index','filament.organization.resources.recordings.create','filament.organization.resources.recordings.edit','filament.organization.tenant','sanctum.csrf-cookie',
